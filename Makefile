...
ifdef RELEASE
	...
	CFLAGS += -ggdb3 -DETH_DEBUG
endif

OBJS = aimbot.o backtrace.o commands.o drawtools.o engine.o eth.o g_functions.o \
	hook.o hud.o medias.o medicbot.o menu.o net.o spycam.o visuals.o windows.o tracer.o
HEADERS = eth.h offsets.h hud.h menu.h net.h types.h windows.h tracer.h names.h
PROG = libETH.so

# libghf
LIBGHF_VERSION = 0.5-1
LIBGHF_FOLDER = ghf
